      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-lg mb-4">
              Mistral-IT est une entreprise spécialisée en solutions informatiques, offrant des services de consultation, d'audit et de remédiation pour aider nos clients à naviguer dans un monde numérique de plus en plus complexe.
            </p>
            <p className="text-lg">
