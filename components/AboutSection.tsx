  ...
  return (
    <section id="about" className="py-20 px-6 lg:px-20 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <p className="text-xs font-semibold text-sky tracking-widest uppercase mb-3">À propos</p>
        <h2 className="font-playfair font-bold text-ink text-3xl sm:text-[2.6rem] leading-tight tracking-tight mb-8">
          Mon parcours et ma façon de travailler
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr] gap-10 items-start">
          ...
          <div className="text-left">
            <p className="text-base lg:text-lg mb-4 text-slate leading-relaxed">
              ...
              dans l'audit, la remédiation et la structuration complète de leur environnement IT.
            </p>

            <p className="text-base lg:text-lg mb-6 text-slate leading-relaxed">
              Mon approche est terrain: je pars de vos contraintes métier, je priorise les actions qui ont un impact
              réel, puis je vous livre un plan concret avec un accompagnement opérationnel.
            </p>

            <div className="grid sm:grid-cols-2 gap-4 mb-6">
              {[
                "6+ ans d'expérience en infrastructures critiques",
                "Spécialisation audit, Active Directory et sécurité réseau",
                "Interventions ponctuelles ou accompagnement long terme",
                "Méthodologie claire avec livrables actionnables",
              ].map((item) => (
            ...
            <p className="text-base lg:text-lg text-slate leading-relaxed">
              Ma mission: rendre votre informatique lisible, robuste et évolutive, sans complexité inutile.
            </p>
          </div>
        </div>
      </div>
